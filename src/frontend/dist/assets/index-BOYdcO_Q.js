...
function SettingsProvider({ children }) {
  const [vibrationEnabled, setVibrationEnabledState] = reactExports.useState(
    () => getLS("ruhani_vibration", true)
  );
  const [soundEnabled, setSoundEnabledState] = reactExports.useState(
    () => getLS("ruhani_sound", false)
  );
  const [defaultTarget, setDefaultTargetState] = reactExports.useState(() => {
    const saved = getLS("ruhani_defaultTarget", 33);
    return typeof saved === "number" && saved > 0 ? saved : 33;
  });
  const [customTarget, setCustomTargetState] = reactExports.useState(() => {
    const saved = getLS("ruhani_customTarget", 33);
    return typeof saved === "number" && saved > 0 ? saved : 33;
  });
  const [language, setLanguageState] = reactExports.useState(
    () => getLS("ruhani_language", "en")
  );
  const [fontSize, setFontSizeState] = reactExports.useState(
    () => getLS("ruhani_fontSize", "medium")
  );
  const [prayerMethod, setPrayerMethodState] = reactExports.useState(
    () => getLS("ruhani_prayerMethod", "MWL")
  );
  const [azanEnabled, setAzanEnabledState] = reactExports.useState(
    () => getLS("ruhani_azan_enabled", true)
  );
  const [dailyDuaNotif, setDailyDuaNotifState] = reactExports.useState(
    () => getLS("ruhani_daily_dua_notif", true)
  );
  const [jummahNotif, setJummahNotifState] = reactExports.useState(
    () => getLS("ruhani_jummah_notif", true)
  );
  const setVibrationEnabled = (v) => {
...
function applyThemeToDom(theme) {
  ...
  root2.style.setProperty("--theme-bg", theme.bg);
  root2.style.setProperty("--theme-bg-mid", theme.bgMid);
  root2.style.setProperty("--theme-primary", theme.primary);
  root2.style.setProperty("--theme-gold", theme.gold);
  root2.style.setProperty("--theme-card", theme.card);
  root2.style.setProperty("--theme-card-border", theme.cardBorder);
  root2.style.setProperty("--theme-text-white", theme.textWhite);
  root2.style.setProperty("--theme-text-cream", theme.textCream);
  root2.style.setProperty("--theme-text-muted", theme.textMuted);
  root2.style.setProperty("--theme-nav-bg", theme.navBg);
  root2.style.setProperty("--theme-nav-inactive", theme.navInactive);
  root2.style.setProperty("--theme-emerald", theme.emerald);
  root2.style.setProperty("--theme-toggle-off", theme.toggleOff);
  root2.style.setProperty("--theme-toggle-thumb", theme.toggleThumb);
  root2.style.setProperty("--theme-pill-text", theme.pillText);
}
function initTheme() {
  let saved = "layl";
  try {
    const v = localStorage.getItem("ruhani_theme");
    if (v && v in THEMES) saved = v;
  } catch {
  }
...
function ThemeProvider({ children }) {
  const [themeId, setThemeIdState] = reactExports.useState(savedThemeId);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme, themeId, setThemeId }, children });
}
function useTheme() {
...
const duas = [
  {
    ...
    translationHi: "ऐ अल्लाह, तेरे ही नाम पर हम सुबह करते हैं, तेरे ही नाम पर जीते और मरते हैं",
    translationUr: "اے اللہ، تیرے ہی نام پر صبح کرتے ہیں، تیرے نام پر جیتے اور مرتے ہیں",
    source: "Abu Dawud 5068",
    when: "Upon waking each morning",
    benefit: "Begins the day in remembrance of Allah and acknowledgment of His power over life",
    tag: "Sahih"
  },
  {
    id: 2,
    ...
    transliteration: "Bismillahi'l-ladhi la yadurru ma'a ismihi shay'un fi'l-ardi wa la fi's-sama'i wa huwa's-Sami'u'l-'Alim",
    ...
    translationHi: "अल्लाह के नाम से — जिसके नाम से ज़मीन-आसमान में कोई चीज़ नुकसान नहीं दे सकती",
    translationUr: "اللہ کے نام سے — جس کے نام سے زمین آسمان میں کوئی نقصان نہیں دے سکتی",
  ...
  },
  {
    ...
    translation: "We have entered morning and the kingdom belongs to Allah; praise be to Allah, there is no god but Allah alone with no partner.",
    translationHi: "हम सुबह हुए और अल्लाह का राज्य सुबह हुआ, तमाम तारीफ़ें अल्लाह के लिए हैं",
    translationUr: "ہم نے صبح کی اور اللہ کی بادشاہی نے صبح کی، تمام تعریفیں اللہ کے لیے ہیں",
  ...
  },
  {
    ...
    translationHi: "अल्लाह — उसके सिवा कोई पूज्य नहीं, वो जीवित और सदा क़ायम है (आयत अल-कुर्सी)",
    translationUr: "اللہ کے سوا کوئی معبود نہیں، وہ زندہ اور قائم ہے — آیت الکرسی",
    source: "Abu Dawud 5068",
  ...
  },
  {
    ...
    translationUr: "میں اللہ کی مکمل کلمات کی پناہ لیتا ہوں اس کی مخلوق کی برائی سے",
  ...
  },
  {
    ...
    transliteration: "Allahu la ilaha illa huwa'l-Hayyu'l-Qayyum, la ta'khudhuhu sinatun wa la nawm, lahu ma fis-samawati wa ma fil-ard...",
    translation: "Allah — there is no god except Him, the Ever-Living, the Sustainer of existence. Neither drowsiness overtakes Him nor sleep. To Him belongs whatever is in the heavens and whatever is on the earth. (Ayat al-Kursi)",
    translationHi: "अल्लाह — उसके सिवा कोई पूज्य नहीं, जीवित और क़ायम है। न ऊंघ आती है उसे न नींद (आयत الکرسی)",
    translationUr: "اللہ کے سوا کوئی معبود نہیں، زندہ و قائم ہے، نہ اونگھ نہ نیند — آیت الکرسی",
    source: "Quran 2:255",
    when: "After every obligatory prayer",
    benefit: "Whoever recites it after prayer, only death separates them from Paradise",
    tag: "Quran"
  },
  {
    id: 7,
    ...
    translationHi: "सुब्हानल्लाह (33 बार)، अल्हम्दुलिल्लाह (33 बार)، अल्लाहु अकबर (34 बार)",
    translationUr: "سبحان اللہ (33 بار)، الحمد للہ (33 بار)، اللہ اکبر (34 بار)",
  ...
  },
  {
    ...
    translationHi: "तमाम तारीफें अल्लाह के लिए जिसने हमें बिना किसी ताक़त के खाना खिलाया",
  ...
  },
  {
    ...
    benefit: "Places one's sleep and awakening under Allah's name and protection",
    tag: "Sahih"
  },
  {
    id: 12,
  ...
  },
  {
    ...
    transliteration: "Subhanakal-lahumma wa bihamdika la ilaha illa anta astaghfiruka wa atubu ilayk",
    translation: "Glory be to You, O Allah, and praise. There is no god but You. I seek Your forgiveness and turn to You in repentance.",
    translationHi: "ऐ अल्लाह, तू पाक है, तेरी तारीफ़ है, माफ़ी मांगता हूं और तेरी तरफ़ लौटता हूं",
    translationUr: "اے اللہ، تو پاک ہے، تیری تعریف ہے، معافی مانگتا ہوں اور توبہ کرتا ہوں",
  ...
  },
  {
    ...
    translationHi: "अल्लाह के नाम पर आए, अल्लाह के नाम पर गए और अल्लाह पर भरोसा किया",
    translationUr: "اللہ کے نام پر آئے، اللہ کے نام پر گئے اور اللہ پر بھروسہ کیا",
  ...
  },
  {
    ...
    transliteration: "Allahumma inni as'aluka khayral-mawliji wa khayral-makhraji, bismillahi walajna, wa bismillahi kharajna",
    translation: "O Allah, I ask You for the best entrance and the best exit. In the name of Allah we enter and in the name of Allah we leave.",
    translationHi: "ऐ अल्लाह, आने-जाने की बेहतरी मांगता हूं — बिस्मिल्लाह करके आए और गए",
    translationUr: "اے اللہ، آنے جانے کی بھلائی مانگتا ہوں — بسم اللہ کہہ کر آئے اور گئے",
    source: "Abu Dawud 5096",
  ...
  },
  {
    ...
    translation: "Sufficient for me is Allah; there is no god but He. In Him I put my trust, and He is the Lord of the Mighty Throne.",
    translationHi: "मुझे अल्लाह काफ़ी है, उसके सिवा कोई पूज्य नहीं, उसी पर भरोसा है",
    translationUr: "میرے لیے اللہ کافی ہے، اس کے سوا کوئی معبود نہیں، اسی پر بھروسہ",
  ...
  },
  {
    ...
    translationHi: "ऐ हमारे रब, दुनिया में भी भलाई दे, आख़िरत में भी भलाई दे और जहन्नम से बचा",
    translationUr: "اے ہمارے رب، دنیا میں بھی بھلائی دے، آخرت میں بھی بھلائی دے اور جہنم سے بچا",
    source: "Quran 2:201",
  ...
  },
  {
    ...
    transliteration: "Allahumma inni as'aluka'l-'afiyata fid-dunya wa'l-akhirah",
  ...
  },
  {
    ...
    benefit: "Covers five essential needs: forgiveness, mercy, guidance, health, and provision",
    tag: "Sahih"
  },
  {
    id: 21,
  ...
  },
  {
    ...
    translation: "There is no god but You; glory be to You. Indeed, I have been of the wrongdoers (Dua of Prophet Yunus).",
    translationHi: "तेरे सिवा कोई पूज्य नहीं, तू पाक है, मैं ज़ालिमों में से था — दुआए यूनुस",
    translationUr: "تیرے سوا کوئی معبود نہیں، تو پاک ہے، میں ظالموں میں تھا — دعاء یونس",
    source: "Quran 21:87",
    when: "In times of distress and hardship",
    benefit: "No Muslim calls upon Allah with these words except that Allah answers",
    tag: "Quran"
  },
  {
    id: 23,
    ...
    benefit: "Greets the new day with praise and awareness of Allah's gift of life",
    tag: "Sahih"
  },
  {
    id: 24,
    ...
    translationHi: "ऐ अल्लाह, तेरे ही नाम पर सुबह करते हैं — तेरे ही नाम पर जीते और मरते हैं",
    translationUr: "اے اللہ، تیرے ہی نام پر صبح کرتے ہیں — تیرے نام پر جیتے اور مرتے ہیں",
  ...
  },
  {
    ...
    translationHi: "ऐ अल्लाह, तेरे ही नाम पर शाम करते हैं — तेरे ही नाम पर जीते और मरते हैं",
    translationUr: "اے اللہ، تیرے ہی نام پر شام کرتے ہیں — تیرے نام پر جیتے اور مرتے ہیں",
    source: "Sunan at-Tirmidhi",
  ...
  },
  {
    ...
    translationHi: "ऐ अल्लाह, तू सलामती है और तुझसे ही सलामती है — बरकत वाले हो तू ऐ शान वाले",
    translationUr: "اے اللہ، تو سلامتی ہے اور تجھ سے ہی سلامتی — برکت والے ہو تو اے شان والے",
    source: "Sahih Muslim",
  ...
  },
  {
    ...
    benefit: "Invites Allah's blessing into the meal and prevents Shaytan from sharing it",
    tag: "Sahih"
  },
  {
    id: 28,
  ...
  },
  {
    ...
    transliteration: "Alhamdu lillahil-lathi at'amana wa saqana wa ja'alana muslimin",
    ...
    translationUr: "تمام تعریفیں اللہ کے لیے جس نے کھلایا، پلایا اور مسلمان بنایا",
    source: "Sunan Abi Dawud",
    when: "After finishing a meal",
  ...
  },
  {
    ...
    name: "Entering Home",
    category: "Home",
    arabic: "اَللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ الْمَوْلَجِ وَخَيْرَ الْمَخْرَجِ بِسْمِ اللهِ وَلَجْنَا وَبِسْمِ اللهِ خَرَجْنَا وَعَلَى اللهِ رَبِّنَا تَوَكَّلْنَا",
    ...
    translation: "O Allah, I ask You for goodness in my entry and my departure. In the name of Allah we enter, in the name of Allah we leave, and upon Allah our Lord we rely.",
    translationHi: "ऐ अल्लाह, आने-जाने की बेहतरी मांगता हूं — अल्लाह के नाम से आए और गए और उस पर भरोसा",
    translationUr: "اے اللہ، آنے جانے کی بھلائی مانگتا ہوں — اللہ کے نام سے آئے گئے اور اسی پر بھروسہ",
    source: "Sunan Abi Dawud",
  ...
  },
  {
    ...
    translationHi: "अल्लाह के नाम से, अल्लाह पर भरोसा किया, ताक़त और क़ुव्वत सिर्फ़ अल्लाह से है",
  ...
  },
  {
    ...
    translationHi: "अल्लाह के सिवा कोई पूज्य नहीं, वो जीवित क़ायम है — न ऊंघ आती है न नींद — आयत अल-कुर्सी",
    translationUr: "اللہ کے سوا کوئی معبود نہیں، زندہ و قائم ہے — نہ اونگھ نہ نیند — آیت الکرسی",
    source: "Quran 2:255",
    when: "After every obligatory prayer and before sleeping",
    benefit: "Greatest verse in the Quran; protects one from Shaytan until dawn",
    tag: "Quran"
  },
  {
    id: 34,
    ...
    translationHi: "ऐ अल्लाह, ग़म, दुख, कमज़ोरी, सुस्ती, बुज़दिली, क़र्ज़ और लोगों के ज़ुल्म से पनाह मांगता हूं",
    translationUr: "اے اللہ، غم، دکھ، کمزوری، سستی، بزدلی، قرض اور لوگوں کے ظلم سے پناہ مانگتا ہوں",
    source: "Sahih al-Bukhari",
  ...
  },
  {
    ...
    translationUr: "اے میرے رب، ان پر ویسا رحم فرما جیسے انہوں نے مجھے بچپن میں پالا",
    source: "Quran 17:24",
    when: "After every prayer and whenever remembering one's parents",
    benefit: "Fulfills the child's duty and earns mercy for parents in the Hereafter",
    tag: "Quran"
  },
  {
    id: 36,
    ...
    transliteration: "Subhanal-lathi sakhkhara lana hadha wa ma kunna lahu muqrinin, wa inna ila rabbina lamunqalibun",
    translation: "Glory be to He who subjected this to us, and we were not capable of that, and indeed to our Lord we will return.",
    translationHi: "पाक है वो जिसने इसे हमारे लिए वश में किया — हम इसके लायक़ न थे — हम रब की तरफ़ लौटेंगे",
    translationUr: "پاک ہے وہ جس نے اسے مسخر کیا — ہم اس کے قابل نہ تھے — ہم رب کی طرف لوٹیں گے",
    source: "Quran 43:13–14; Sahih Muslim 1342",
    when: "When boarding a vehicle, plane, or beginning any journey",
    benefit: "Acknowledges Allah's blessing over transport and reminds of the return to Allah",
    tag: "Quran"
  },
  {
    id: 37,
    ...
    translationHi: "हम लौटते हैं, तौबा करते हैं, इबादत करते हैं और अपने रब की तारीफ़ करते हैं",
    translationUr: "ہم لوٹتے ہیں، توبہ کرتے ہیں، عبادت کرتے ہیں اور اپنے رب کی تعریف کرتے ہیں",
    source: "Sahih Muslim",
    when: "Upon returning home from a journey",
    benefit: "Marks return from travel with repentance, worship, and praise of Allah",
    tag: "Sahih"
  },
  {
    id: 38,
  ...
  },
  {
    ...
    translationHi: "मैं गवाही देता हूं कि अल्लाह के सिवा कोई पूज्य नहीं और मुहम्मद ﷺ उसके बंदे और रसूल हैं",
    translationUr: "میں گواہی دیتا ہوں کہ اللہ کے سوا کوئی معبود نہیں اور محمد ﷺ اس کے بندے اور رسول ہیں",
    source: "Sahih Muslim",
    when: "Immediately after completing wudu",
    benefit: "The eight gates of Paradise are opened for whoever says this after wudu",
    tag: "Sahih"
  },
  {
    id: 54,
    ...
    transliteration: "Allahumma aj'alni minat-tawwabin wa aj'alni minal-mutatahhirin",
    ...
    translationUr: "اے اللہ، مجھے توبہ کرنے والوں اور پاک رہنے والوں میں شامل کر",
    source: "Jami at-Tirmidhi",
    when: "After completing wudu",
    benefit: "Asks Allah to count you among the blessed who repent often and stay pure",
    tag: "Hasan"
  },
  {
    id: 44,
    ...
    translation: "O Allah, You are my Lord, there is no god but You. You created me and I am Your servant, and I am faithful to my covenant and promise to You as best I can. I seek refuge in You from the evil of what I have done. I acknowledge Your favor upon me and I acknowledge my sin, so forgive me, for none forgives sins but You.",
    translationHi: "ऐ अल्लाह, तू मेरा रब है, तेरे सिवा कोई पूज्य नहीं — सय्यिद उल-इस्तिग़फ़ार",
    translationUr: "اے اللہ، تو میرا رب ہے، تیرے سوا کوئی معبود نہیں — سید الاستغفار",
    source: "Sahih al-Bukhari",
    when: "In the morning and evening; whoever says it with conviction and dies that day enters Paradise",
    benefit: "The master of forgiveness; sins erased if said sincerely morning or evening",
    tag: "Sahih"
  },
  {
    id: 45,
    ...
    translationUr: "اے اللہ، جیسی تو نے میری شکل بنائی، ویسے میرے اخلاق بھی اچھے بنا",
    source: "Musnad Ahmad",
  ...
  },
  {
    ...
    transliteration: "Allahumma rabban-nas, adhhibil-ba's, ishfihi wa antas-shafi, la shifa'a illa shifa'uka shifa'an la yughadiru saqama",
    translation: "O Allah, Lord of mankind, remove the affliction and cure him, for You are the Healer. There is no cure except Your cure, a cure that leaves no illness behind.",
    translationHi: "ऐ अल्लाह, लोगों के रब, तकलीफ़ दूर कर, शिफ़ा दे — तू ही असली शिफ़ा देने वाला है",
    translationUr: "اے اللہ، لوگوں کے رب، تکلیف دور کر، شفا دے — تو ہی حقیقی شفا دینے والا ہے",
    source: "Sahih al-Bukhari, Sahih Muslim",
    when: "When placing your hand on the forehead of someone who is sick",
    benefit: "Supplicates the Lord of all people for complete and lasting recovery",
    tag: "Sahih"
  },
  {
    id: 48,
    ...
    benefit: "Dua of Prophet Ibrahim; righteous children are the greatest legacy",
    tag: "Quran"
  },
  {
    id: 49,
    ...
    translationHi: "ऐ हमारे रब, हमें बीवी-बच्चों से आंखों की ठंडक दे और हमें मुत्तक़ीन का इमाम बना",
    translationUr: "اے ہمارے رب، ہمیں بیوی بچوں سے آنکھوں کی ٹھنڈک دے اور متقین کا امام بنا",
    source: "Quran 25:74",
    when: "Daily; especially for those seeking harmony in family life",
    benefit: "Asks for joy through family and the honour of being an imam of the righteous",
    tag: "Quran"
  },
  {
    id: 50,
    ...
    benefit: "Calls for barakah in sustenance and protection from the Fire in one dua",
    tag: "Hasan"
  },
  {
    id: 51,
    ...
    translation: "O Allah, suffice me with what You have made lawful against what You have made unlawful, and enrich me with Your bounty above all others.",
    translationHi: "ऐ अल्लाह, हलाल के ज़रिये हराम से बेनियाज़ कर और अपने फ़ज़्ल से सबसे बेनियाज़ कर",
    translationUr: "اے اللہ، حلال کے ذریعے حرام سے بے نیاز کر اور فضل سے سب سے بے نیاز کر",
    source: "Sunan at-Tirmidhi",
  ...
  },
  {
    ...
    benefit: "Simple yet profound; the only thing Allah commanded the Prophet to ask more of",
    tag: "Quran"
  },
  {
    id: 53,
    ...
    translationHi: "ऐ अल्लाह, जो इल्म दिया उससे फ़ायदा दे, जो मुफ़ीद हो वो सिखा और इल्म बढ़ा",
    translationUr: "اے اللہ، جو علم دیا اس سے فائدہ دے، فائدہ مند علم سکھا اور علم بڑھا",
  ...
  },
  {
    ...
    translation: "Say: He is Allah, the One (Surah Ikhlas); Say: I seek refuge with the Lord of the daybreak (Surah Falaq); Say: I seek refuge with the Lord of mankind (Surah Nas)",
  ...
  },
  {
    ...
    translationUr: "میں اللہ کے کامل کلمات کی پناہ مانگتا ہوں ہر اس چیز کی برائی سے جو اس نے پیدا کی",
    source: "Sahih Muslim",
    when: "When stopping at a place, before sleeping, or when feeling afraid",
    benefit: "Protection from evil, harmful creatures, and all that Allah has created",
    tag: "Sahih"
  },
  {
    id: 62,
    ...
    translation: "O Allah, I am Your servant, son of Your servant, son of Your maidservant. My forelock is in Your hand, Your command over me is forever executed, Your decree over me is just. I ask You by every name belonging to You which You named Yourself with, or revealed in Your Book, or taught to any of Your creation, or have preserved in the knowledge of the unseen with You, that You make the Quran the life of my heart and the light of my breast, and a departure for my sorrow and a release for my anxiety.",
    translationHi: "हे अल्लाह, मैं तेरा बंदा हूँ, तेरे बंदे का बेटा हूँ... क़ुरआन को मेरे दिल की बहार बना दे और मेरी उदासी को दूर कर दे",
    translationUr: "اے اللہ، میں تیرا بندہ ہوں، تیرے بندے کا بیٹا ہوں... قرآن کو میرے دل کی بہار بنا دے اور میری پریشانی دور فرما",
    source: "Musnad Ahmad (Hasan)",
    when: "When feeling overwhelmed, anxious, sad, or distressed",
    benefit: "Removes grief and anxiety; Allah replaces sorrow with joy and ease",
    tag: "Hasan"
  },
  {
    id: 63,
    ...
    translationHi: "हे अल्लाह, कोई चीज़ आसान नहीं सिवाय उसके जो तू आसान कर दे, और तू जब चाहे मुश्किल को आसान बना देता है",
    translationUr: "اے اللہ، کوئی چیز آسان نہیں مگر جسے تو آسان بنا دے، اور تو جب چاہے مشکل کو آسان کر دیتا ہے",
  ...
  },
  {
    ...
    translationHi: "तमाम तारीफें उस अल्लाह के लिए जिसने मुझे यह खाना खिलाया और मुझे यह रिज्क दिया बिना मेरी किसी ताकत या कोशिश के",
    translationUr: "تمام تعریف اس اللہ کے لیے جس نے مجھے یہ کھانا کھلایا اور میری کسی طاقت اور کوشش کے بغیر مجھے یہ رزق عطا فرمایا",
...
function DuasTab() {
  ...
  const [favorites, setFavorites] = reactExports.useState(getFavorites);
  const [highlightedDuaId, setHighlightedDuaId] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const scrollTimer = setTimeout(() => {
      var _a2;
      const card = (_a2 = scrollContainerRef.current) == null ? void 0 : _a2.querySelector(
        `[data-dua-id="${id}"]`
      );
      if (card) {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    if (search.trim()) {
      ...
      result = result.filter(
        (d) => {
          var _a2, _b2, _c2, _d2;
          return d.arabic.includes(search) || (((_a2 = d.transliteration) == null ? void 0 : _a2.toLowerCase().includes(q)) ?? false) || d.translation.toLowerCase().includes(q) || (((_b2 = d.translationHi) == null ? void 0 : _b2.toLowerCase().includes(q)) ?? false) || (((_c2 = d.translationUr) == null ? void 0 : _c2.includes(search)) ?? false) || d.source.toLowerCase().includes(q) || (((_d2 = d.name) == null ? void 0 : _d2.toLowerCase().includes(q)) ?? false);
        }
      );
    }
    return result;
  }, [activeCategory, favorites, search]);
  const headerBackground = themeId === "layl" ? "linear-gradient(180deg, rgba(4,8,15,0.9) 0%, transparent 100%)" : theme.isLight ? `linear-gradient(180deg, ${theme.bg}f2 0%, transparent 100%)` : "linear-gradient(180deg, rgba(8,15,30,0.95) 0%, transparent 100%)";
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "14", y: "7", fontSize: "6", fill: theme.gold, children: "✶" })
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: language === "hi" ? "हि" : language === "ur" ? "اردو" : "EN"
                }
              )
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 16px 10px", flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              width: "16",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "11", cy: "11", r: "7", stroke: theme.gold, strokeWidth: "2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
                    d: "M16.5 16.5 L21 21",
            ...
            children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No duas found" })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: filtered.map((dua, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              DuaCard,
              {
                dua,
                index: idx + 1,
...
function DuaCard({
  ...
  const [heartAnimating, setHeartAnimating] = reactExports.useState(false);
  const [copied, setCopied] = reactExports.useState(false);
  const displayTranslation = language === "hi" && dua.translationHi ? dua.translationHi : language === "ur" && dua.translationUr ? dua.translationUr : dua.translation;
...
— ${dua.source}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `duas.item.${index2}`,
      "data-dua-id": dua.id,
      style: {
        borderRadius: 18,
        background: theme.card,
        border: `1px solid ${highlighted ? "#d4a843" : theme.cardBorder}`,
        boxShadow: highlighted ? "0 0 0 2px #d4a843, 0 0 28px 6px rgba(212,168,67,0.45), 0 2px 20px rgba(0,0,0,0.3)" : theme.isLight ? "0 2px 12px rgba(139,105,20,0.1)" : "0 2px 20px rgba(0,0,0,0.3)",
        position: "relative",
        overflow: "hidden",
        padding: "14px 14px 14px 18px",
        animation: highlighted ? `cardSlideUp 0.4s ease ${index2 * 60}ms both, duaGlowPulse 2.5s ease forwards` : `cardSlideUp 0.4s ease ${index2 * 60}ms both`,
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    tagStyle && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 6, alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13 }, children: "💬" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      cursor: "pointer",
                      padding: 4,
                      animation: heartAnimating ? "heartPop 300ms ease" : void 0,
                      lineHeight: 1
                    },
        ...
        dua.name && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              fontFamily: "'Nunito', sans-serif",
        ...
        dua.transliteration && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              fontFamily: "'Nunito', sans-serif",
        ...
        (dua.when || dua.benefit) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              background: theme.isLight ? "rgba(139,105,20,0.06)" : "rgba(255,255,255,0.04)",
            ...
            children: [
              dua.when && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    fontFamily: "'Nunito', sans-serif",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: dua.when })
                  ]
                }
              ),
              dua.benefit && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    fontFamily: "'Nunito', sans-serif",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: dua.benefit })
                  ]
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: [
          ...
          dua.note && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                fontFamily: "'Nunito', sans-serif",
...
const ASMA_UL_HUSNA = [
  {
    ...
    benefit: "Reciting this name brings closeness to Allah and fills the heart with light"
  },
  {
    number: 2,
    arabic: "الرَّحْمَنُ",
  ...
  },
  {
    ...
    benefit: "Reciting 40 times after Fajr for 40 days removes dependency on others"
  },
  {
    number: 10,
    arabic: "الْجَبَّارُ",
  ...
  },
  {
    ...
    benefit: "Reciting 133 times daily brings ease and sustenance from unexpected sources"
  },
  {
    number: 32,
    arabic: "الْخَبِيرُ",
  ...
  },
  {
    ...
    benefit: "Reciting 70 times protects from evil and sufficient against enemies"
  },
  {
    number: 42,
    arabic: "الْجَلِيلُ",
  ...
  },
  {
    ...
    benefit: "Reciting 66 times brings relief from anxiety and full trust in Allah"
  },
  {
    number: 54,
    arabic: "الْقَوِيُّ",
  ...
  },
  {
    ...
    benefit: "Reciting 63 times after each prayer brings blessings and gratitude"
  },
  {
    number: 58,
    arabic: "الْمُحْصِي",
  ...
  },
  {
    ...
    benefit: "Reciting helps overcome fear and begins new endeavors with blessing"
  },
  {
    number: 60,
    arabic: "الْمُعِيدُ",
  ...
  },
  {
    ...
    benefit: "Reciting brings contentment and the ability to find what is sought"
  },
  {
    number: 66,
    arabic: "الْمَاجِدُ",
  ...
  },
  {
    ...
    benefit: "Reciting Surah Ikhlas (containing this name) equals 1/3 of the Quran"
  },
  {
    number: 69,
    arabic: "الصَّمَدُ",
  ...
  },
  {
    ...
    meaning: "The First",
    benefit: "Reciting 40 times for 40 Fridays brings a child for those without"
  },
  {
    number: 75,
    arabic: "الآخِرُ",
  ...
  },
  {
    ...
    benefit: "Reciting on Laylat al-Qadr: 'Allahumma innaka afuwwun tuhibbul afwa fa'fu anni'"
  },
  {
    number: 84,
    arabic: "الرَّؤُوفُ",
  ...
  },
  {
    ...
    benefit: "Reciting 100 times in one sitting removes calamity by Allah's permission"
  },
  {
    number: 93,
    arabic: "النَّافِعُ",
...
function NamesTab() {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return ASMA_UL_HUSNA.filter(
      (n) => n.arabic.includes(search) || n.transliteration.toLowerCase().includes(q) || n.meaning.toLowerCase().includes(q) || n.benefit.toLowerCase().includes(q) || n.number.toString() === search.trim()
    );
  }, [search]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", style: { background: "transparent" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 20px 12px", flexShrink: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
          ...
          children: "أَسْمَاءُ اللهِ الحُسْنى"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 16px 10px", flexShrink: 0 }, children: [
      ...
      "div",
      {
        ...
        children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 32 }, children: "✨" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No names found" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: filtered.map((name, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(NameCard, { name, index: idx + 1 }, name.number)) })
      }
    )
  ] });
}
function NameCard({ name, index: index2 }) {
  const { theme } = useTheme();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `names.item.${index2}`,
      style: {
        borderRadius: 16,
        background: theme.card,
        border: `1px solid ${theme.cardBorder}`,
        padding: "14px 16px",
        animation: `cardSlideUp 0.4s ease ${Math.min(index2 * 40, 400)}ms both`,
        display: "flex",
        gap: 12,
        alignItems: "flex-start"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              style: {
                background: theme.isLight ? "rgba(139,105,20,0.06)" : "rgba(255,255,255,0.03)",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.gold, flexShrink: 0 }, children: "✨" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: name.benefit })
              ]
            }
          )
        ] })
...
function getTodaysDua() {
  const day = getDayOfYear(/* @__PURE__ */ new Date());
  const index2 = day % duas.length;
  return duas[index2];
}
function msUntil8AM() {
...
function scheduleDailyDuaNotification() {
  try {
  ...
  scheduledTimer = setTimeout(async () => {
    ...
    if (typeof Notification !== "undefined" && Notification.permission === "granted") {
      try {
        const snippet = dua.arabic.length > 40 ? `${dua.arabic.slice(0, 40)}...` : dua.arabic;
    ...
    try {
      localStorage.setItem(LAST_SCHEDULED_KEY, (/* @__PURE__ */ new Date()).toDateString());
    } catch {
    }
    scheduledTimer = null;
...
function toHijriLocal(date) {
  ...
  const JD = 367 * Y - Math.floor(7 * (Y + Math.floor((M + 9) / 12)) / 4) + Math.floor(275 * M / 9) + D + 17210135e-1;
...
async function fetchHijriFromApi(date) {
  var _a2, _b2, _c2;
  try {
    ...
    const hijri = (_a2 = json == null ? void 0 : json.data) == null ? void 0 : _a2.hijri;
    if (!hijri) return null;
    const day = Number.parseInt(hijri.day, 10);
    const month = ((_b2 = hijri.month) == null ? void 0 : _b2.number) ?? 1;
    const year = Number.parseInt(hijri.year, 10);
    const monthName = HIJRI_MONTHS[month - 1] ?? ((_c2 = hijri.month) == null ? void 0 : _c2.en) ?? "";
...
function computePrayerTimes(lat, lng, method, date) {
  ...
  const JD = (y2, m, d2) => {
    ...
    const yr = y2 + 4800 - a;
    const mo2 = m + 12 * a - 3;
    return d2 + Math.floor((153 * mo2 + 2) / 5) + 365 * yr + Math.floor(yr / 4) - Math.floor(yr / 100) + Math.floor(yr / 400) - 32045;
  };
  const y = date.getFullYear();
  const mo = date.getMonth() + 1;
  const d = date.getDate();
  const julDay = JD(y, mo, d) + 12 / 24;
  const D = julDay - 2451545;
  ...
  const fajrAngle = method === "ISNA" ? 15 : method === "Karachi" ? 18 : method === "UmmAlQura" ? 18.5 : 18;
  const ishaAngle = method === "ISNA" ? 15 : method === "Karachi" ? 18 : method === "UmmAlQura" ? 90 / 60 : method === "Hanafi" ? 18 : 17;
  const hour = (angle) => {
    const val = (-Math.sin(toRad(angle)) - Math.sin(toRad(lat)) * Math.sin(toRad(decl))) / (Math.cos(toRad(lat)) * Math.cos(toRad(decl)));
...
function PrayerTimesTab() {
  ...
  const [prayerTimes, setPrayerTimes] = reactExports.useState(null);
  const [permissionState, setPermissionState] = reactExports.useState("idle");
  const [now2, setNow] = reactExports.useState(/* @__PURE__ */ new Date());
  const [azanPrefs, setAzanPrefs] = reactExports.useState(() => loadAzanPrefs());
  const [showAzanSettings, setShowAzanSettings] = reactExports.useState(false);
  const [hijri, setHijri] = reactExports.useState(() => toHijriLocal(/* @__PURE__ */ new Date()));
  const [hijriLoading, setHijriLoading] = reactExports.useState(true);
  const refreshTimerRef = reactExports.useRef(null);
  const azanTimersRef = reactExports.useRef([]);
  const hijriDateKeyRef = reactExports.useRef("");
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    fetchHijriFromApi(today).then((result) => {
      if (result) setHijri(result);
      setHijriLoading(false);
    }).catch(() => setHijriLoading(false));
  }, []);
  const scheduleAzan = reactExports.useCallback(
    (times) => {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        fetch(
          ...
          const city = ((_a2 = data == null ? void 0 : data.address) == null ? void 0 : _a2.city) || ((_b2 = data == null ? void 0 : data.address) == null ? void 0 : _b2.town) || ((_c2 = data == null ? void 0 : data.address) == null ? void 0 : _c2.village) || ((_d2 = data == null ? void 0 : data.address) == null ? void 0 : _d2.county) || "";
          const country = ((_f2 = (_e2 = data == null ? void 0 : data.address) == null ? void 0 : _e2.country_code) == null ? void 0 : _f2.toUpperCase()) || "";
  ...
  const countdownMs = nextPrayer && prayerTimes ? Math.max(0, prayerTimes[nextPrayer].getTime() - now2.getTime()) : null;
  const cardStyle = {
    background: theme.card,
    border: `1px solid ${theme.cardBorder}`,
    borderRadius: 16,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", style: { background: "transparent" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                permissionState === "granted" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    style: {
                      padding: "8px 14px",
                      borderRadius: 999,
                      background: azanEnabled ? `${theme.gold}22` : "rgba(255,255,255,0.06)",
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: azanEnabled ? "🔔" : "🔕" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Azan" })
                    ]
                  }
                )
              ]
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: now2.toLocaleDateString("en-US", {
                        weekday: "long",
                        day: "numeric",
                        month: "long",
                        year: "numeric"
                  ...
                  locationName && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                        display: "flex",
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: locationName }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: isFriday2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          showAzanSettings && permissionState === "granted" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                ...cardStyle,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "✶ Per-Prayer Azan"
                  }
                ),
                AZAN_PRAYERS.map((prayer, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                      ...
                      borderBottom: i < AZAN_PRAYERS.length - 1 ? `1px solid ${theme.cardBorder}` : "none"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: PRAYER_DISPLAY[prayer].icon }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: PRAYER_DISPLAY[prayer].label })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            ...
                            height: 24,
                            borderRadius: 12,
                            background: azanPrefs[prayer] ? theme.emerald : theme.toggleOff,
                            border: "none",
                            cursor: "pointer",
                            position: "relative",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "Global Azan toggle is in Settings → Notifications"
                  }
                )
              ]
            }
          ),
          permissionState === "granted" && nextPrayer && prayerTimes && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: formatTime(prayerTimes[nextPrayer])
                  }
                ),
                countdownMs !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
          ...
          permissionState === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "Allow location access to get accurate prayer times for your city"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
          ...
          permissionState === "loading" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          permissionState === "denied" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "Location access denied"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "Please enable location permissions in your browser settings and try again"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
          ...
          permissionState === "granted" && prayerTimes && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: Object.keys(PRAYER_DISPLAY).map((prayer) => {
            const isNext = prayer === nextPrayer;
            const isPast = now2 > prayerTimes[prayer];
            const display = PRAYER_DISPLAY[prayer];
            const isAzanable = AZAN_PRAYERS.includes(prayer);
            const azanOn = isAzanable && azanEnabled && azanPrefs[prayer];
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  ...
                  alignItems: "center",
                  justifyContent: "space-between",
                  boxShadow: isNext ? `0 0 20px ${theme.gold}33, inset 0 0 20px ${theme.gold}08` : void 0,
                  border: isNext ? `1px solid ${theme.gold}66` : `1px solid ${theme.cardBorder}`,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 22 }, children: display.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        isAzanable && azanEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: formatTime(prayerTimes[prayer])
                          }
                        )
                      ]
                    }
...
function msUntilFridayNoon() {
  const now2 = /* @__PURE__ */ new Date();
  const target = new Date(now2);
  const currentDay = now2.getDay();
  const daysUntilFriday = (5 - currentDay + 7) % 7;
  target.setDate(now2.getDate() + daysUntilFriday);
...
function getTodayFridayStr() {
  const now2 = /* @__PURE__ */ new Date();
  const target = new Date(now2);
  const daysUntilFriday = (5 - now2.getDay() + 7) % 7;
  target.setDate(now2.getDate() + daysUntilFriday);
  return target.toDateString();
}
let jummahTimer = null;
function scheduleJummahNotification() {
  ...
  jummahTimer = setTimeout(async () => {
    ...
    try {
      localStorage.setItem(LAST_JUMMAH_DATE_KEY, (/* @__PURE__ */ new Date()).toDateString());
    } catch {
    }
    jummahTimer = null;
    scheduleJummahNotification();
...
function ThemeSelector() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 24 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Themes" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      ...
                      borderRadius: "50%",
                      overflow: "hidden",
                      border: isSelected ? `2.5px solid ${theme.gold}` : `2px solid ${theme.cardBorder}`,
                      boxShadow: isSelected ? `0 0 12px ${themeColors.primary}60` : "none",
...
function AboutDisclaimerSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "About & Disclaimer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "About Ruhani"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...bodyStyle, marginBottom: 16 }, children: "Ruhani – Duas & Tasbeeh is a simple Islamic app designed to help Muslims stay connected with daily duas, tasbeeh, and remembrance of Allah. The app provides authentic supplications with Arabic text, transliteration, and meanings for easy understanding." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 4 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Features" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: features.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              display: "flex",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Disclaimer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: disclaimerParagraphs.map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: para }, para.slice(0, 30))) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: "Made with ❤️ for the Ummah"
        }
      ) })
    ] }) })
  ] });
...
function PrivacyPolicySection() {
  ...
  const BulletList = ({ items }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Privacy Policy" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...bodyStyle, marginBottom: 16 }, children: "Ruhani – Duas & Tasbeeh respects your privacy and is committed to protecting your personal information. This policy explains how we collect, use, and safeguard your data." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Information We Collect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BulletList, { items: collectItems })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "How We Use Information" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BulletList, { items: useItems })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Permissions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BulletList, { items: permissionItems })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Data Sharing" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: bodyStyle, children: [
          "We do",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.gold, fontWeight: 700 }, children: "NOT" }),
          " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Third-Party Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: "The app may use trusted third-party services (such as APIs for prayer times), which may collect limited technical data." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Security" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: "We take reasonable steps to protect your data, but no method is 100% secure." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Children's Privacy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: "This app does not knowingly collect data from children under 13." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Changes to Policy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: bodyStyle, children: "We may update this Privacy Policy from time to time. Changes will be reflected on this page." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: goldDividerStyle }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...bodyStyle, marginBottom: 6 }, children: "If you have any questions, contact us at:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "mailto:ruhaniapp@gmail.com",
...
function SettingsTab() {
  ...
  const [customInput, setCustomInput] = reactExports.useState(
    customTarget > 0 && !TARGETS.includes(customTarget) ? customTarget.toString() : ""
  );
  const headerBackground = themeId === "layl" ? "linear-gradient(180deg, rgba(4,8,15,0.9) 0%, transparent 100%)" : void 0;
  const handleNotifToggle = async (setter, currentValue) => {
  ...
  const PillButton = ({
    ...
    "button",
    {
      ...
      style: {
        ...
        cursor: "pointer",
        transition: "all 0.2s ease",
        background: active ? `linear-gradient(135deg, ${theme.gold}, ${theme.primary})` : theme.card,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col h-full", style: { background: "transparent" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Notifications" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SettingRow,
              {
                ...
                right: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    on: azanEnabled,
                    onToggle: () => handleNotifToggle(setAzanEnabled, azanEnabled),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SettingRow,
              {
                ...
                right: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    on: dailyDuaNotif,
                    onToggle: () => handleNotifToggle(setDailyDuaNotif, dailyDuaNotif),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Language" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 16 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: "Dua translation language"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 10 }, children: ["en", "hi", "ur"].map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              PillButton,
              {
                active: language === lang,
                onClick: () => setLanguage(lang),
                ocid: "settings.toggle",
                children: lang === "en" ? "🇬🇧 English" : lang === "hi" ? "🇮🇳 हिन्दी" : "🇵🇰 اردو"
              },
              lang
            )) })
          ] }) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Font Size" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 16 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "App text size"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 10 }, children: ["small", "medium", "large"].map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              PillButton,
              {
                active: fontSize === size,
                onClick: () => setFontSize(size),
                ocid: "settings.toggle",
                children: size === "small" ? "S" : size === "medium" ? "M" : "L"
              },
              size
            )) })
          ] }) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Prayer Method" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 16 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "Calculation method for prayer times"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: PRAYER_METHODS.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              PillButton,
              {
            ...
            prayerMethod === "ISNA" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  marginTop: 8,
                ...
                children: "ISNA: North America method (15° Fajr/Isha)"
              }
            ),
            prayerMethod === "Hanafi" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  marginTop: 8,
                ...
                children: "Hanafi: Uses shadow length x2 for Asr"
              }
            )
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Tasbeeh Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SettingRow,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { children: "Default Target" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 16 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "Counter target for dhikr sessions"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 10, marginBottom: 12 }, children: TARGETS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  cursor: "pointer",
                  transition: "all 0.2s ease",
                  background: defaultTarget === t ? `linear-gradient(135deg, ${theme.gold}, ${theme.primary})` : theme.card,
                  color: defaultTarget === t ? "#ffffff" : theme.textCream,
                  border: defaultTarget === t ? "none" : `1px solid ${theme.cardBorder}`
                },
                children: t
              },
              t
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    padding: "10px 16px",
                    borderRadius: 12,
                    background: customInput && Number.parseInt(customInput, 10) > 0 ? `linear-gradient(135deg, ${theme.gold}, ${theme.primary})` : theme.card,
                    border: `1px solid ${theme.cardBorder}`,
                    color: theme.textWhite,
                    fontFamily: "'Nunito', sans-serif",
                    fontWeight: 400,
            ...
            customTarget > 0 && !TARGETS.includes(customTarget) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  marginTop: 8,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AboutDisclaimerSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PrivacyPolicySection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "16px 0 8px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
              ...
              children: "بَارَكَ اللَّهُ فِيكُم"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Made with love for the Ummah 🤲"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", paddingBottom: 8 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
            style: {
              fontFamily: "'Nunito', sans-serif",
...
function TasbeehTab() {
  ...
  const [sessionTotal, setSessionTotal] = reactExports.useState(0);
  ...
  const [confetti] = reactExports.useState(
    () => Array.from({ length: 20 }, (_, i) => ({
      ...
      delay: `${Math.random() * 1e3}ms`
    }))
  );
  const [tapping, setTapping] = reactExports.useState(false);
  const celebrationTimeout = reactExports.useRef(null);
  const rippleCounter = reactExports.useRef(0);
  const countRef = reactExports.useRef(count);
  const selected = DHIKR_PRESETS.find((d) => d.id === selectedId) ?? DHIKR_PRESETS[0];
  ...
  const arabicTextShadow = isLayl ? `0 0 30px ${theme.gold}cc, 0 0 15px ${theme.gold}88` : `0 0 20px ${theme.gold}99`;
  const circleBackground = isLayl ? "rgba(4,12,24,0.9)" : theme.isLight ? `radial-gradient(circle at center, ${theme.bgMid} 0%, ${theme.bg} 70%)` : `radial-gradient(circle at center, #0a1a2e 0%, ${theme.bg} 70%)`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        celebrating && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: [
              confetti.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    position: "absolute",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    soundEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                    ...
                    vibrationEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: { fontSize: 14, opacity: 0.7 },
                        title: "Vibration on",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: selected.transliteration
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: selected.meaning
                }
              ),
              customTarget > 0 && customTarget !== selected.target && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    fontFamily: "'Nunito', sans-serif",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    isLayl && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          ...
                          position: "relative",
                          overflow: "hidden",
                          animation: tapping ? "tapBounce 200ms ease" : void 0,
                          zIndex: 2,
                          backdropFilter: isLayl ? "blur(4px)" : void 0
                        },
                        children: [
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  style: {
                                    ...
                                    display: "block",
                                    textShadow: isLayl ? `0 0 20px ${theme.gold}99, 0 0 40px ${theme.gold}66` : void 0
                                  },
                                  children: count
                                },
                                count
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    alignSelf: "center",
                    flexShrink: 0,
                    backdropFilter: isLayl ? "blur(8px)" : void 0
                  },
                  children: "Reset"
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "8px 0 12px", flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              display: "flex",
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    ...
                    padding: "8px 16px",
                    borderRadius: 999,
                    background: isSelected ? `${primaryHex}26` : isLayl ? "rgba(255,255,255,0.07)" : theme.card,
                    backdropFilter: "blur(10px)",
                    border: isSelected ? `1px solid ${theme.gold}` : isLayl ? "1px solid rgba(201,168,76,0.2)" : `1px solid ${theme.cardBorder}`,
...
function IslamicBackground() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            position: "fixed",
            inset: 0,
            background: "radial-gradient(ellipse at top, #0d2137 0%, #050d1a 50%, #020810 100%)",
            zIndex: 0
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "100%", height: "100%", fill: "url(#islamicStar8Layl)" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          xmlns: "http://www.w3.org/2000/svg",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "32", y: "30", width: "22", height: "170", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "43", cy: "30", rx: "11", ry: "18", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "39", y: "10", width: "8", height: "20", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "26", y: "70", width: "34", height: "6", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "26", y: "90", width: "34", height: "6", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "426", y: "30", width: "22", height: "170", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "437", cy: "30", rx: "11", ry: "18", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "433", y: "10", width: "8", height: "20", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "420", y: "70", width: "34", height: "6", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "420", y: "90", width: "34", height: "6", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "155", cy: "110", rx: "55", ry: "40", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "100", y: "110", width: "110", height: "90", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "325", cy: "110", rx: "55", ry: "40", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "270", y: "110", width: "110", height: "90", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "240", cy: "70", rx: "90", ry: "70", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "150", y: "70", width: "180", height: "130", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "55", y: "140", width: "370", height: "60", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "200", cy: "150", rx: "14", ry: "20", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "240", cy: "150", rx: "14", ry: "20", fill: "#0a1e32" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "280", cy: "150", rx: "14", ry: "20", fill: "#0a1e32" })
          ]
        }
      )
    ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    !theme.isLight && STARS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "fixed",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "100%", height: "100%", fill: "url(#islamicStar)" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    !theme.isLight && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        viewBox: "0 0 480 80",
        preserveAspectRatio: "xMidYMax meet",
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "60", y: "20", width: "18", height: "60", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "69", cy: "20", rx: "9", ry: "14", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "65", y: "6", width: "8", height: "14", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "402", y: "20", width: "18", height: "60", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "411", cy: "20", rx: "9", ry: "14", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "407", y: "6", width: "8", height: "14", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "240", cy: "50", rx: "130", ry: "50", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "110", y: "50", width: "260", height: "30", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "160", cy: "52", rx: "40", ry: "28", fill: "#0a1a20" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "320", cy: "52", rx: "40", ry: "28", fill: "#0a1a20" })
        ]
      }
    )
  ] });
...
function SplashScreen({ onDone }) {
  ...
  const done = reactExports.useRef(false);
  reactExports.useEffect(() => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: phase >= 3 && SPLASH_LETTER_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "5", x2: "12", y2: "18", stroke: color, strokeWidth: "1.2" })
      ]
    }
  );
}
function PrayerIcon({ color }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      width: "22",
...
function AppInner() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("tasbeeh");
  const [animKeys, setAnimKeys] = reactExports.useState({
    tasbeeh: 0,
    duas: 0,
    prayer: 0,
    names: 0,
  ...
  const getIcon = (id, color) => {
    switch (id) {
      case "tasbeeh":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TasbeehIcon, { color });
      case "duas":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DuasIcon, { color });
      case "prayer":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(PrayerIcon, { color });
      case "names":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(NamesIcon, { color });
      case "settings":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsIcon, { color });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    themeId !== "layl" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "fixed",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslamicBackground, {}),
    showSplash && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, { onDone: () => setShowSplash(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minHeight: 0, position: "relative" }, children: NAV_ITEMS.map(({ id }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    position: "absolute",
                    ...
                    flexDirection: "column",
                    animation: activeTab === id ? "tabSlideIn 280ms ease" : void 0
                  },
                  children: [
                    id === "tasbeeh" && /* @__PURE__ */ jsxRuntimeExports.jsx(TasbeehTab, {}),
                    id === "duas" && /* @__PURE__ */ jsxRuntimeExports.jsx(DuasTab, {}),
                    id === "prayer" && /* @__PURE__ */ jsxRuntimeExports.jsx(PrayerTimesTab, {}),
                    id === "names" && /* @__PURE__ */ jsxRuntimeExports.jsx(NamesTab, {}),
                    id === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsTab, {})
                  ]
                },
                `${id}-${animKeys[id]}`
              )) }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppInner, {}) }) });
}
